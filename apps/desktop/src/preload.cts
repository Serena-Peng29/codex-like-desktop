...
contextBridge.exposeInMainWorld("desktop", {
  ...
  createRechargeOrder: (credits: number, channel: "wechat" | "alipay") => ipcRenderer.invoke("billing:create-order", credits, channel),
  getRechargeOrder: (orderId: string) => ipcRenderer.invoke("billing:get-order", orderId),
  mockPayOrder: (orderId: string) => ipcRenderer.invoke("billing:mock-pay", orderId),
