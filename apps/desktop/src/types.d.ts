...
declare global {
  interface Window {
    desktop: {
      ...
      login(account: string, password: string): Promise<{ user: { id: string; account: string; kind: string }; models: string[] }>;
      logout(): Promise<void>;
      billingState(): Promise<{ signedIn: boolean; balanceUsd: number | null; unlimited: boolean }>;
